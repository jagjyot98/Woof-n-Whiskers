                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                   ...
                   // String email = "" + ds.child("email").getValue();
                    ...
                    try {
                        ...
                        Picasso.get().load(R.drawable.ic_displaypic).into(avatarIv);
                    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    //adapter
                    adapterPost = new AdapterPost(OtherProfileActivity.this, postList);
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(OtherProfileActivity.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
