...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i) {
        ...
        Log.d("AdapterComment", "Name: " + name);
        myHolder.commentTv.setText(comment);
        Log.d("AdapterComment", "Name: " + comment);
        myHolder.timeTv.setText(pTime);
        //set user dp
        try {
            Picasso.get().load(image).placeholder(R.drawable.ic_displaypic).into(myHolder.avatarIv);
        }
        catch (Exception e){}
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            avatarIv = itemView.findViewById(R.id.dpcomment);
            nameTv = itemView.findViewById(R.id.nameCmt);
