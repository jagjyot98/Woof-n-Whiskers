...
import com.example.woofNwhiskers.adapters.AdapterComment;
import com.example.woofNwhiskers.model.ModelComment;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    try {
                        ...
                        Picasso.get().load(myDp).placeholder(R.drawable.ic_displaypic).into(cAvatarIv);
                    }
                    catch (Exception e){
                        Picasso.get().load(R.drawable.ic_displaypic).into(cAvatarIv);
                    }
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    try {
                        Picasso.get().load(hisDp).placeholder(R.drawable.ic_displaypic).into(uPictureIv);
                    }catch (Exception e){
                        Picasso.get().load(R.drawable.ic_displaypic).into(uPictureIv);
                    }
